...
export class IncomeController {
  ...
  @ApiBadRequestResponse({
    description: 'Geçersiz gelir bilgileri',
  ...
  @ApiNotFoundResponse({
    description: 'Güncellenecek gelir bulunamadı',
    type: ErrorResponseDto,
  })
  @ApiBadRequestResponse({
    description: 'Geçersiz gelir ID veya güncelleme verisi',
    type: ErrorResponseDto,
  })
  update(
    @Param('id') id: string,
  ...
  @ApiCommandResponse()
  @ApiNotFoundResponse({
    description: 'Silinecek gelir bulunamadı',
    type: ErrorResponseDto,
  })
  @ApiBadRequestResponse({
    description: 'Geçersiz gelir ID',
